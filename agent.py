...
def decide(
    ...
    # Not enough data yet to compute the long moving average -> do nothing.
    ...
    if uptrend:
        # Target: invest up to MAX_POSITION_WEIGHT of total equity in SPY.
        ...
        # Downtrend -> move fully out of SPY into cash.
        if held_shares > 0:
